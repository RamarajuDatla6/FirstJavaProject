...
//The method should return boolean and it needs to return true if the product of the first and second parameter is equal to the third parameter.
...
public class EqualProductChecker {
    ...
    public static void main(String[]args){
        ...
        int num2 =sc.nextInt();
        int num3 = sc.nextInt();
        boolean check = hasEqualProduct(num1,num2,num3);
